...
class Settings(BaseSettings):
    ...
    SCARY_AUTHORS: str= 'Tomodachi 梦醒幻实 AbilfloridaArts 四奈乃 云起 極彩色 阡陌菌 千樺·エイミー・ザル Trishnicajoy PShiro 黑虎阿符 BT1 BALD Tay-X Meigane 过度解毒 「雪」 资源出口 阿曼達·木子 MilkMan29 興趣使然'
    ...
    # Deployment settings
    FRONTEND_URL: str = 'http://192.168.2.1:8080'
